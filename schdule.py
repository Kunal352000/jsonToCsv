...
with open('Schedule Location.csv', 'w', newline='') as file:
    ...
    for _ in range(10):
        ...
        row = [partition_key, sort_key, category_id, category_name, client_details, "", "", 
               ...
               f"#USER#{random.randint(10000, 99999)}", f"TrainerName{random.randint(1, 50)}", "", "", appointment_id]
        writer.writerow(row)
...
with open('Schedule Client.csv', 'w', newline='') as file:
    ...
    for location_row in location_data:
        appointment_id = location_row[23]  # Previously location_row[24]
        client_details = location_row[4]

        writer.writerow([appointment_id, "", appointment_id, client_details["clientChildBirthDate"], 
                         ...
                         client_details["clientParentName"], "", "", location_row[7], location_row[9], 
                         "", location_row[8], location_row[23], client_details["payLater"], 
